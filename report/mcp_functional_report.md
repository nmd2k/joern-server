...
| `get_method_callees`                                 | ✓ PASS           | 232ms   | ["method_full_name=assert                                                                                                |
...
| `get_method_by_call_id`                              | ✓ PASS           | 227ms   | method_full_name=WriteTIFFImage                                                                                          |
| `get_referenced_method_full_name_by_call_id`         | ✓ PASS           | 228ms   | TIFFClose                                                                                                                |
| `get_class_full_name_by_id`                          | ✓ PASS           | 227ms   | content.c:                                                                                                               |
| `get_class_methods_by_class_full_name`               | ✓ PASS           | 232ms   | ["methodFullName=content.c: methodId=107374182401L","methodFullName=TIFFPrintDirectory methodId=107374182403L"]          |
| `get_method_code_by_class_full_name_and_method_name` | ✓ PASS           | 231ms   | ["methodFullName=content.c: methodId=107374182401L"]                                                                     |
