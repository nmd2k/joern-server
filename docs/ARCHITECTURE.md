...
**Related docs:** [Query Guide](query_guide.md) · [Deployment Guide](deploy.md) · `http_api.md`
...
See the [Query Guide](query_guide.md) for a full `importCpg` + `query-sync` walkthrough.
...
Details: [Deployment Guide](deploy.md). Sprint 9 consolidates compose files to two profiles (`compose.dev.yml`, `compose.scale.yml`).
